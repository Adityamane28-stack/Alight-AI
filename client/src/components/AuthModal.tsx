...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen }) => {
  ...
  // User allows permissions on the Google screen
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      {/* ============================================================== */}
      {/* GOOGLE SIGN-IN FLOW (Account Selection & Permissions Screen)    */}
      {/* ============================================================== */}
      {isGoogleModalOpen ? (
            ...
            {googleStep === 'select-account' && (
              <>
                ...
                <p className="text-sm text-stone-500 mt-1">
                  to continue to <span className="font-semibold text-stone-700">Alight</span>
                </p>
              </>
            )}
          ...
          {googleStep === 'permissions' && selectedGoogleAccount && (
            <div className="px-8 pb-8">
              ...
              <p className="text-[11px] text-stone-500 leading-relaxed mb-6">
                By clicking <strong>Allow</strong>, you permit <strong>Alight</strong> to link with your Google profile to sign you in securely. You can manage access in your Google Account settings.
              </p>
              ...
              <div className="flex items-center justify-between gap-3 pt-2 border-t border-stone-100">
                <button
                  ...
                  className="px-4 py-2.5 text-xs font-medium text-stone-600 hover:text-stone-800 hover:bg-stone-100 rounded-xl transition cursor-pointer"
                >
                  Cancel
                </button>
              ...
              >
                {authMode === 'signup' ? (
                  <>
                    ...
                    <span className="font-semibold text-amber-400 underline decoration-amber-500/50">
                      Sign In
                    </span>
                  </>
                ) : (
